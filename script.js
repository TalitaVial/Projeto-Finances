//Modal para inculir entrada ou saída
const Modal = {
  open(){
      //Abrir modal
...
// addiciona, remove e atualiza as transações
const Transaction = { 
  all: Storage.get(),
...
const DOM = {
  transactionContainer: document.querySelector('#data-table'),
...
//tratamento do formulario e validação dos dados 
const Form = {
